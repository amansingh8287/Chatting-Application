                ...
                selectedUser !== null ? (
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col h-full">
                            ...
                            {/* HEADER */}
                            <div className='flex gap-2 items-center px-4 py-2 bg-white/30 backdrop-blur-md border-b border-white/20 text-black'>
                                <img
                                    src={selectedUser?.profilePhoto}
                            ...
                            {/* 🔥 TYPING INDICATOR */}
                            {typing && (
                                <p className="text-sm text-gray-600 px-4 py-1">
                                    Typing...
                                </p>
                            )}
